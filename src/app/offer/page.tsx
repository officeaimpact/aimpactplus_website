...
export const metadata = pageMetadata({
  ...
  description:
    "Публичная оферта на оказание услуг ООО «ИИМПАКТ ПЛЮС» в области внедрения ИИ-решений для туризма.",
  path: "/offer",
});
  ...
  return (
    <PageShell>
      <PageHero
        eyebrow="Юридическое"
        title="Публичная оферта"
        description="Документ описывает условия оказания услуг по разработке и внедрению ИИ-решений для туристического бизнеса."
        crumbs={[
          { name: "Главная", href: "/" },
      ...
      <section className="section">
        <div className="prose-card mx-auto">
          ...
          <p>
            ...
            внедрению ИИ-решений (ассистенты, виджеты, CRM-интеграции,
