...
export const metadata = pageMetadata({
  ...
  description:
    "Кейсы ИИМПАКТ ПЛЮС: корпоративный AI-ассистент для туроператора речных круизов «ИНФОФЛОТ», AI-помощник для «Сети Магазинов Горящих Путёвок» и отеля Delas. Реальные задачи, решения и интеграции в туристической отрасли.",
  path: "/cases",
});
