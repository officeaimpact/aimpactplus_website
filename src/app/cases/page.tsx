...
export const metadata = pageMetadata({
  ...
  description:
    "Кейсы ИИМПАКТ ПЛЮС: корпоративный AI-ассистент для туроператора речных круизов «ИНФОФЛОТ», AI-помощник для «Сети Магазинов Горящих Путёвок» и мини-гостиницы Delas. Реальные задачи, решения и интеграции в туристической отрасли.",
  path: "/cases",
});
  ...
  return (
    <PageShell>
      ...
      <SectionWrapper
        ...
        description="Туроператор речных круизов, сеть турагентств и средство размещения — три формата AI-внедрения с разной глубиной задач и интеграций."
      >
