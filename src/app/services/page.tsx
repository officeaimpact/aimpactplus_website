...
const pricingFactors: ReadonlyArray<{
  ...
  },
  {
    ...
    text: "Robot-обзвон, IVR, AI-оператор для входящих. Тарификация зависит от минут и интеграции с телефонией.",
  },
  {
    icon: ShieldCheck,
...
const pricingTiers: ReadonlyArray<PricingTier> = [
  ...
  },
  {
    ...
    description:
      "AI-ассистент в сайте и мессенджерах с прямой передачей лидов в CRM, подключением Tourvisor и обучением на FAQ-базе клиента. Личный кабинет с аналитикой.",
  ...
  },
  {
    ...
    description:
      "AI-продукт под задачи компании: своя модель данных, голосовой канал, нестандартные интеграции (PMS, BI, IATA), отдельные сценарии под сегменты и страны.",
...
export const metadata = pageMetadata({
  title: "Услуги и стоимость — внедрение AI в туризме",
  description:
    "Услуги ИИМПАКТ ПЛЮС: разработка кастомных AI-решений и приложений, интеграции в ПО и CRM, чат-боты, голосовые ассистенты, AI-аналитика, обучение и консалтинг. От чего зависит стоимость и сроки запуска — в разделе «Стоимость».",
  path: "/services",
  keywords: [
  ...
  return (
    <PageShell>
      ...
      <PageHero
        ...
        description="От стратегии и аудита до разработки индивидуальных AI-приложений, интеграций, голосовых ассистентов и обучения команды. К каждой услуге можно оставить отдельную заявку — и мы сразу поймём, что именно вам нужно."
        crumbs={[
          { name: "Главная", href: "/" },
      ...
      <CtaBand
        ...
        text="Начнём с короткого AI-аудита. Покажем, что даст быстрый эффект, и где ROI самый высокий."
        cta="Запросить аудит"
      />
    </PageShell>
  );
