...
export const alt = `${site.brand} — блог`;
...
/**
 * Динамическая OG-картинка под конкретный пост блога.
 * Берёт title, category и дату из blogPosts[] и рендерит в фирменном стиле.
 */
export default async function BlogOgImage({
  ...
  const title = post?.title ?? "Блог о внедрении ИИ в туризм";
  const category = post?.category ?? "Блог";
  const dateLabel = post?.publishedDisplay ?? "";
