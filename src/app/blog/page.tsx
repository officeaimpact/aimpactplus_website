...
export const metadata = pageMetadata({
  ...
  description:
    "Статьи и разборы про внедрение искусственного интеллекта в туристический бизнес: AI-турменеджер, AI-ассистенты, аналитика, кейсы и архитектура решений.",
  path: "/blog",
  keywords: [
    "блог AI в туризме",
  ...
  return (
    <PageShell>
      ...
      <PageHero
        ...
        description="Разбираем технологию без хайпа: что такое AI-турменеджер, чем он отличается от чат-бота, какие задачи закрывает в турагентствах, отелях и у туроператоров."
        crumbs={[
          { name: "Главная", href: "/" },
          { name: "Блог", href: "/blog" },
        ]}
      ...
      <CtaBand
        ...
        text="Расскажите задачу — соберём прототип AI-решения и план пилота."
      />
    </PageShell>
  );
}
