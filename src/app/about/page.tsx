...
export const metadata = pageMetadata({
  ...
  description:
    "ООО «ИИМПАКТ ПЛЮС» (бренд AIMPACT+) — IT-команда, которая с 2023 года внедряет AI-решения в туризм: продукт «Навылет! AI», 15+ клиентов, прошли Fast Track IT в Фонде «Сколково».",
  path: "/about",
});
...
const milestones = [
  {
    year: "2023",
    title: "Старт направления AI в туризме",
    text: "Команда начала разрабатывать первые AI-ассистенты и виджеты под задачи турагентств и туроператоров. В декабре 2023 — участие в итоговом заседании Комитета ТПП РФ по предпринимательству в сфере туризма.",
  },
  {
    year: "2024",
    title: "Публичная экспертиза и кейсы",
    text: "Внедрения для клиентов разных сегментов: туроператоры, сети агентств, средства размещения. Выступления на профильных площадках: ТПП РФ, РСТ, Совет по AI, региональные форумы.",
  },
  {
    year: "2025",
    title: "Продукт «Навылет! AI» и Сколково",
    text: "Запущен собственный продукт «Навылет! AI» — готовый AI-турменеджер для сайтов туристических компаний. Команда успешно прошла Fast Track IT в Фонде «Сколково». Партнёрства с РСТ, ТПП РФ, МГИМО, РЭУ им. Г. В. Плеханова.",
  },
];

const stats = [
  { value: "2023", label: "год запуска направления AI в туризме" },
  { value: "15+", label: "клиентов из туриндустрии" },
...
export default function About() {
  return (
    <PageShell>
      <PageHero
        eyebrow="О компании"
        title={`${site.legalName} — IT-команда AI-интеграций для туризма с 2023 года`}
        description="Проектируем и внедряем AI-решения для туристического бизнеса с 2023 года. Запустили собственный продукт «Навылет! AI», работаем с 15+ компаниями отрасли, прошли Fast Track IT в Фонде «Сколково» и регулярно выступаем на ключевых отраслевых площадках России."
        crumbs={[
          { name: "Главная", href: "/" },
      ...
      <SectionWrapper
        eyebrow="Хроника"
        title="Как мы росли"
        description="Три ключевых этапа становления ИИМПАКТ ПЛЮС как профильного AI-интегратора для туризма."
        alt
      >
        ...
        <div className="grid gap-5 md:grid-cols-3">
          <article className="card">
            ...
            <p className="mt-3 leading-7 text-body">
              С 2023 года занимаемся только AI в туризме. Понимаем сценарии
              продаж, специфику Tourvisor, особенности B2B и B2C-каналов и
              реальные проблемы менеджеров.
            </p>
          </article>
          <article className="card">
            <span className="grid h-12 w-12 place-items-center rounded-2xl bg-gradient-to-br from-primary to-accent text-white shadow-[var(--shadow-blue)]">
            ...
            <p className="mt-3 leading-7 text-body">
              Готовый AI-турменеджер для сайта: каскадный диалог, подбор туров
              на базе поисковой системы Tourvisor, FAQ и передача заявки
              менеджеру. Подключается за 1 день. Этим продуктом уже пользуются
              15+ компаний отрасли.
            </p>
          </article>
          <article className="card">
          ...
          <article className="card">
            ...
            <p className="mt-3 leading-7 text-body">
              ...
              Махачкале. Формируем повестку по AI в туризме.
            </p>
          </article>
          <article className="card">
            <span className="grid h-12 w-12 place-items-center rounded-2xl bg-gradient-to-br from-primary to-accent text-white shadow-[var(--shadow-blue)]">
      ...
      <SectionWrapper
        ...
        description="Ключевые отраслевые площадки, на которых мы представили AI-решения для туризма за последние два года."
        alt
      >
      ...
      <SectionWrapper
        ...
        description="Профессиональное сообщество отмечает наш вклад в развитие AI-технологий в туризме."
      >
          ...
          <article className="card flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-body">
                Вручена основателям ИИМПАКТ ПЛЮС вице-президентом Российского
                союза туриндустрии Юрием Барзыкиным и заместителем председателя
