...
export function ProblemSolution({ id, merge }: SectionAnchorProps = {}) {
  return (
    <SectionWrapper
      ...
      description="Это не «модный AI», а конкретные узкие места, через которые уходит маржа: ночные обращения, типовые вопросы, медленный подбор и слепая аналитика. Каждая из них закрывается AI-решением за 2–8 недель."
    >
      <motion.div
