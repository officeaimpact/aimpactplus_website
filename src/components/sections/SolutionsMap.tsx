...
export function SolutionsMap({ id, merge }: SectionAnchorProps = {}) {
  return (
    <SectionWrapper
      ...
      merge={merge}
      eyebrow="Карта услуг"
      title="От стратегии и аудита до индивидуальных ИИ-приложений"
      description="Не сводим искусственный интеллект к чат-боту. Помогаем туристическим компаниям строить полноценные интеллектуальные продукты — от моделей и интерфейсов до аналитики и омниканальной коммуникации."
    >
      <motion.div
